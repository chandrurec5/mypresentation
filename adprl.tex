...
\begin{comment}
\begin{block}{Useful Norms}
\begin{itemize}
\item $\norm{J_1-J_2}_{1,c}=\sum_{s\in \S} \left|J_1(s)-J_2(s)\right|$
\item $\norm{J_1-J_2}_{D}=\mfrac{1}{2}(J_1-J_2)^\top D (J_1-J_2)$
...
\begin{comment}
\begin{block}{Proof}
Let $\epsilon=\norm{J_1-J_2}_\infty$, then
\begin{align*}
J_1-\epsilon \one&\leq J_2 \leq J_1+ \epsilon \one\\
T(J_1-\epsilon \one)&\leq TJ_2 \leq T(J_1+ \epsilon \one)\\
TJ_1- \alpha\epsilon \one&\leq TJ_2 \leq TJ_1+ \alpha\epsilon \one
\end{align*}
$\norm{TJ_1-TJ_2}_\infty=\alpha\epsilon$
\end{block}
\end{comment}
...
\begin{frame}[fragile]{How to Compress?}
\begin{block}{Approximate Linear Programming{\color{orange}\ding{53}}}
\begin{align*}
...
T(J_1-\epsilon \one)&\leq TJ_2 \leq T(J_1+ \epsilon \one)\\
TJ_1- \alpha\epsilon \one&\leq TJ_2 \leq TJ_1+ \alpha\epsilon \one\\
\Pi_M (TJ_1- \alpha\epsilon \one)&\leq \Pi_M T J_2 \leq \Pi_M(TJ_1+ \alpha\epsilon \one)\\
\Pi_M TJ_1- \alpha\epsilon \one&\leq \Pi_M T J_2 \leq \Pi_MTJ_1+ \alpha\epsilon \one
\end{align*}
$\norm{\Pi_M TJ_1-\Pi_M TJ_2}_\infty=\alpha\epsilon$
\end{block}
\end{comment}
